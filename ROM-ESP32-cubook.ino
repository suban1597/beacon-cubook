...
static const uint8_t HWID[5] = {0x01, 0x37, 0x56, 0xcf, 0xba};  // LINE it-beacon
//static const uint8_t HWID[5] = {0x01, 0x36, 0x87, 0x3a, 0x97};  // LINE it@cubook
...
void loop() {
  ...
  char dm[] = "OK"; //Device Message ที่ต้องการส่งต้องไม่เกิน 13 ตัวอักษร (ความยาวรวม 14 byte)
